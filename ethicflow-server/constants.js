const RATINGS = {
    "praises, no criticism": "A",
    "some praise, no criticism": "B",
    "praises, some criticism": "C",
    "criticisms, some praise": "D",
    "criticisms": "F",
    "no rating": "?"
};
...
const STOP_WORDS = [
    ...
    "he'd", "he'll", "he's", "her", "here", "here's", "hers", "herself", "him", "himself", "his", "how", "how's", "i", "in", "i'd", "i'll", "i'm", 
    "i've", "if", "in", "into", "is", "isn't", "it", "it's", "its", "itself", "let's", "me", "more", "most", "mustn't", "my", "myself", "no", 
    "nor", "not", "of", "off", "on", "once", "only", "or", "other", "ought", "our", "ours", "ourselves", "out", "over", "own", "same", "shan't", 
    "she", "she'd", "she'll", "she's", "should", "shouldn't", "so", "some", "such", "than", "that", "that's", "the", "their", "theirs", "them", "themselves", 
...
module.exports = { RATINGS, STOP_WORDS };